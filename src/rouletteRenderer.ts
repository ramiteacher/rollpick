...
import { type CanvasRect, closeButtonSize, drawCloseCircle } from './closeButton';
...
function inRect(rect: CanvasRect | undefined, x: number, y: number): boolean {
...
export class RouletteRenderer {
  ...
  /** 이름 → 커스텀 스킨. 지금은 비어 있고, 확장 지점으로 남겨둔다 */
  protected _images: { [key: string]: HTMLImageElement } = {};
  protected _theme: ColorTheme = Themes.dark;
  private _resultCloseRect: CanvasRect | null = null;
  ...
  async init() {
    ...
    (document.getElementById('stage') ?? document.body).appendChild(this._canvas);
